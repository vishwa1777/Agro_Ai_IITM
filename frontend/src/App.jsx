...
const useCropRiskData = () => {
    ...
    const chartData = useMemo(() => {
        ...
        return data.map((d) => ({
            ...
            level:
                d._id === "High" || d.riskLevel === "High"
                    ? "High"
                    : d._id === "Medium" || d.riskLevel === "Medium"
                      ? "Medium"
                      : "Low",
        }));
    }, [data]);
...
const LEVEL_BG = {
    ...
    Low: "rgba(249,115,22,0.12)",
    Medium: "rgba(234,179,8,0.12)",
    Healthy: "rgba(74,222,128,0.12)",
};
...
const NAV = [
    { key: "dashboard", icon: <Home size={18} />, label: "Dashboard" },
    {
        ...
        label: "Visit Planner",
        sub: "AI-powered visit planning to maximize your impact",
    },
    {
        key: "aiRecommendations",
        icon: <Lightbulb size={18} />,
        label: "AI Recommendations",
        sub: "Smart recommendations to help you take the right action.",
    },
    {
        key: "riskAnalyzer",
        icon: <Search size={18} />,
        label: "Risk Analyzer",
        sub: "Monitor and mitigate agricultural risks",
    },
    {
        key: "retailerInsights",
        icon: <Store size={18} />,
        label: "Retailer Insights",
        sub: "Detailed performance and insights of retail locations",
    },
    {
        key: "growerInsights",
        icon: <Users size={18} />,
        label: "Grower Insights",
        sub: "Track grower engagement and feedback",
    },
    {
        key: "analytics",
        icon: <BarChart2 size={18} />,
        label: "Analytics",
        sub: "Visualized analytics and data trends",
    },
    {
        key: "settings",
        icon: <Settings size={18} />,
        label: "Settings",
        sub: "Configure your app and region preferences",
    },
    {
        key: "visit",
        icon: <Clipboard size={18} />,
        label: "Visit Performance",
        sub: "Track actual field visits against the target per day",
        hideInSidebar: true,
    },
    {
        key: "revenue",
        ...
        sub: "Track revenue generated across months",
        hideInSidebar: true,
    },
    {
        key: "stock",
        icon: <Bell size={18} />,
        label: "Stock Alerts",
        sub: "Real-time stock status across top products",
        hideInSidebar: true,
    },
    {
        key: "crop",
    ...
    },
    {
        ...
        label: "Weather Alert",
        sub: "Stay prepared for changing weather",
        hideInSidebar: true,
    },
];
...
const KpiCard = ({ icon, iconBg, label, value, valueColor, sub, onClick }) => (
    ...
    >
        ...
        {onClick && (
            <div style={{ fontSize: 10, color: "#4ADE80", marginTop: 6 }}>View details →</div>
        )}
    </div>
);
            ...
            {NAV.filter((n) => !n.hideInSidebar).map((n) => (
                <button
                    ...
                    style={{
                        ...
                        borderLeft:
                            active === n.key ? "3px solid #4ADE80" : "3px solid transparent",
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                {criticalStocks > 0 && (
                    ...
                    >
                        <AlertTriangle size={14} /> {criticalStocks} Critical Stock
                        {criticalStocks !== 1 ? "s" : ""}
                    </div>
                )}
                <div
...
const Overview = ({ tasks, onToggleTask, onNav }) => {
    ...
    const latestRev = revenueChartData.length
    ...
    const avgVisits = visitChartData.length
        ? (totalVisits / visitChartData.length).toFixed(1)
        : "—";
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                    ...
                    >
                        <span style={{ color: "#F8FAFC" }}>Good Morning, </span>
                    ...
                    <div style={{ display: "flex", gap: 10 }}>
                        ...
                        >
                            ...
                            <span style={{ fontSize: 13, fontWeight: 600, color: "#F8FAFC" }}>
                                {dashboard.weather.description ?? "Weather data"}
                            </span>
                        </div>
                    </div>
                )}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 14 }}>
                ...
                <KpiCard
                    ...
                    value={rL ? "…" : latestRev ? `₹${latestRev.revenue}L` : "—"}
                    valueColor="#EAB308"
                    sub={latestRev?.month ?? "Loading"}
                    onClick={() => onNav("revenue")}
                />
                <KpiCard
                    icon={<AlertTriangle size={22} />}
                    iconBg="rgba(239,68,68,0.2)"
                    label="Critical Stocks"
                    value={dashLoading ? "…" : String(dashboard?.criticalStocks ?? 0)}
                    valueColor="#EF4444"
                    sub="Need restocking"
                    onClick={() => onNav("stock")}
                />
                <KpiCard
                    ...
                    value={dashLoading ? "…" : String(dashboard?.highRisk ?? 0)}
                    valueColor="#F97316"
                    sub="High risk level"
                    onClick={() => onNav("crop")}
                />
                <KpiCard
                    ...
                    label="Weather Alert"
                    value={dashLoading ? "…" : dashboard?.weather ? "Active" : "—"}
                    valueColor="#38BDF8"
                    sub="Latest alert"
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <Card>
                    ...
                    {vL ? (
                        ...
                        <ErrMsg msg="No visit data available" />
                    ) : (
                        <ResponsiveContainer width="100%" height={190}>
                            ...
                            >
                                ...
                                />
                                <Tooltip
                                    content={<ChartTip suffix=" visits" />}
                ...
                <Card>
                    ...
                    {rL ? (
                        ...
                        <ErrMsg msg="No revenue data available" />
                    ) : (
                        <ResponsiveContainer width="100%" height={190}>
                            <AreaChart
                            ...
                            >
                                <defs>
                                    <linearGradient id="rG" x1="0" y1="0" x2="0" y2="1">
                                        ...
                                        <stop offset="90%" stopColor="#84CC16" stopOpacity={0.02} />
                                    </linearGradient>
                                </defs>
                                <CartesianGrid
                                    strokeDasharray="4 4"
                                    ...
                                    content={({ active, payload, label }) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div style={{ color: "#84CC16", fontWeight: 700 }}>
                                                    ₹{payload[0].value}L
                                                </div>
                                            </div>
                                        );
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.3fr 0.7fr", gap: 16 }}>
                            ...
                            tasks.map((task) => {
                                ...
                                return (
                                    <div
                                        ...
                                        onClick={() => onToggleTask(task._id ?? task.id)}
                                        style={{
                                            display: "flex",
                                            alignItems: "center",
                                            gap: 14,
                                            ...
                                            border: `1px solid ${task.done ? "rgba(255,255,255,0.05)" : typeColor + "30"}`,
                                            borderRadius: 10,
                                            padding: "10px 14px",
                                    ...
                                    >
                                        <div
                                            style={{
                                                ...
                                                background: task.done ? typeColor : "transparent",
                                                display: "flex",
                                                alignItems: "center",
                                                justifyContent: "center",
                                                flexShrink: 0,
                ...
                <Card>
                    ...
                    >
                        <div style={{ fontSize: 14, fontWeight: 700, color: "#F8FAFC" }}>
                            <Wheat size={14} style={{ marginRight: 8, verticalAlign: "middle" }} />
                            Crop Risk
                        </div>
                        <button
                            onClick={() => onNav("crop")}
                            ...
                            {cropChartData.map((d) => (
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            style={{
                                                width: `${Math.min(d.risk, 100)}%`,
                                                height: "100%",
                                                background: CROP_COLOR(d.level),
                                                borderRadius: 3,
...
const VisitPage = () => {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <PageHeader
                filterOptions={["Last 4 Weeks", "Last 8 Weeks", "This Month", "Last Month"]}
                filter={filter}
                onFilter={setFilter}
            />
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14 }}>
                ...
                <KpiCard
                    ...
                    value={loading ? "…" : `${Math.round((avg / TARGET) * 100)}%`}
                    valueColor="#F97316"
                    sub="of Target"
                />
                <KpiCard
                        ...
                        >
                            ...
                            <Bar dataKey="visits" radius={[8, 8, 0, 0]}>
                                {chartData.map((d, i) => (
                                    <Cell
                                        key={i}
                                        fill={d.visits >= TARGET ? "url(#gB2)" : "#EF4444"}
                                    />
                                ))}
                            </Bar>
                        </BarChart>
...
const RevenuePage = () => {
    ...
    const highest = chartData.length
        ? chartData.reduce((m, d) => (d.revenue > m.revenue ? d : m), chartData[0])
        : null;
    const growth =
        chartData.length > 1
            ? (
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <PageHeader
                filterOptions={["Last 6 Months", "Last 3 Months", "This Year", "Last Year"]}
                filter={filter}
                onFilter={setFilter}
            />
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14 }}>
                ...
                <KpiCard
                    ...
                    iconBg="rgba(249,115,22,0.2)"
                    label="Highest Month"
                    value={loading ? "…" : highest ? `₹${highest.revenue}L` : "—"}
                    valueColor="#F97316"
                    sub={highest?.month ?? ""}
                />
                <KpiCard
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        ...
                        >
                            ...
                            <Area
                                ...
                                dot={({ cx, cy, payload }) => (
                                    <g key={payload.month}>
                                        <circle cx={cx} cy={cy} r={5} fill="#84CC16" />
                                        <text
                                            x={cx}
                                            y={cy - 12}
                                            textAnchor="middle"
...
const StockPage = () => {
    ...
    const products = useMemo(() => {
        ...
        return rawProducts.map((p) => {
            ...
            const level =
                pct <= 20 ? "Critical" : pct <= 40 ? "Low" : pct <= 70 ? "Medium" : "Healthy";
            return {
                ...p,
                _pct: pct,
    ...
    const counts = useMemo(() => {
        ...
        products.forEach((p) => {
            if (c[p._level] !== undefined) c[p._level]++;
        });
        return c;
    }, [products]);

    const filtered =
        levelFilter === "All" ? products : products.filter((p) => p._level === levelFilter);

    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <PageHeader
                filterOptions={["All Warehouses", "Jhansi Depot", "Agra Depot", "Kanpur Depot"]}
                filter={filter}
                onFilter={setFilter}
            />
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14 }}>
                {[
                    ...
                    <div
                        key={sc.key}
                        onClick={() => setLevelFilter((l) => (l === sc.key ? "All" : sc.key))}
                        style={{
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                {loading ? "…" : counts[sc.key]}{" "}
                                <span style={{ fontSize: 13, color: "#94A3B8", fontWeight: 400 }}>
                                    Products
                                </span>
                            </div>
                            {levelFilter === sc.key && (
                                <div style={{ fontSize: 10, color: sc.color, marginTop: 4 }}>
                                    ● Filtered
                                </div>
                            )}
                        </div>
                    ...
                    <div style={{ fontSize: 14, fontWeight: 700, color: "#F8FAFC" }}>
                        ...
                        {levelFilter !== "All" && (
                            <span
                                style={{
                                    fontSize: 11,
                                    color: LEVEL_COLOR[levelFilter],
                                    background: LEVEL_BG[levelFilter],
                                    borderRadius: 5,
                                    padding: "2px 8px",
                                    marginLeft: 8,
                                }}
                                        ...
                                        >
                                                ...
                                                >
                                                    <div
                                                        style={{
                                                            width: `${p._pct}%`,
                                                            height: "100%",
                                                            background: LEVEL_COLOR[p._level],
                                                            borderRadius: 3,
                                                        }}
                                                    />
                                                </div>
                                            ...
                                            <td style={{ padding: "12px 16px" }}>
                                                <span
                                                    style={{
                                                        fontSize: 11,
                                                        background: LEVEL_BG[p._level],
                                                        color: LEVEL_COLOR[p._level],
                                                        border: `1px solid ${LEVEL_COLOR[p._level]}40`,
                                                        borderRadius: 6,
                                                        padding: "4px 10px",
                                                        fontWeight: 700,
                                                        whiteSpace: "nowrap",
...
const CropPage = () => {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <PageHeader
                filterOptions={["This Season", "Last Season", "Kharif 2024", "Rabi 2024"]}
                filter={filter}
                onFilter={setFilter}
            />
            <Card>
                ...
                {loading ? (
                    ...
                    <ErrMsg msg="No crop risk data available" />
                ) : (
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart
                            data={chartData}
                            barSize={70}
                            margin={{ top: 20, right: 20, left: -18, bottom: 0 }}
                        >
                            <CartesianGrid
                                strokeDasharray="3 3"
                                stroke="rgba(255,255,255,0.05)"
                            ...
                            />
                            <Tooltip
                                content={<ChartTip suffix=" records" />}
                                cursor={{ fill: "rgba(255,255,255,0.03)" }}
                            />
                            <Bar dataKey="risk" radius={[6, 6, 0, 0]}>
                                {chartData.map((d, i) => (
                                    <Cell key={i} fill={CROP_COLOR(d.level)} />
                                ))}
                            </Bar>
                        </BarChart>
                    </ResponsiveContainer>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 16 }}>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <MapPin size={14} /> {weather.location ?? "Your Region"}
                            </div>
                            {weather.precipitation_probability != null && (
                                ...
                                >
                                    <CloudRain size={14} />
                                    <span style={{ color: "#CBD5E1" }}>Rain Probability:</span>
                                    <span
                                        style={{ color: "#38BDF8", fontWeight: 700, fontSize: 16 }}
                                    >
                        ...
                        <Card>
                            ...
                            {forecastData.length > 0 ? (
                                <ResponsiveContainer width="100%" height={220}>
                                    ...
                                    >
                                        <defs>
                                            <linearGradient id="rnG" x1="0" y1="0" x2="0" y2="1">
                                                <stop
                                                    offset="0%"
                                                    stopColor="#3B82F6"
                                                    stopOpacity={0.35}
                                ...
                                <div style={{ color: "#475569", fontSize: 12, padding: "20px 0" }}>
                                    No hourly forecast data available from weather API.
                                </div>
                            )}
                        </Card>
                        <div
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: 13, color: "#CBD5E1" }}>
                                    {weather.suggestion ??
                                        "Check local forecast before scheduling field visits."}
                                </div>
                            </div>
                        </div>
                    </div>
...
const RetailerInsightsPage = () => {
    ...
    const stats = useMemo(() => {
        const lowStock = retailers.filter((r) =>
            ["Critical", "Low Stock"].includes(r.stockLevel ?? r.alertLevel)
        ).length;
        const outstanding = retailers.reduce(
            (s, r) => s + (r.outstanding ?? r.outstandingBalance ?? 0),
            0
        );
    ...
    const filtered = useMemo(
        () =>
            retailers.filter((r) => {
                ...
                if (filter === "Low Stock")
                    return ["Critical", "Low Stock"].includes(r.stockLevel ?? r.alertLevel);
                if (filter === "Outstanding")
                    return (r.outstanding ?? r.outstandingBalance ?? 0) > 0;
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14 }}>
                ...
                <KpiCard
                    ...
                    value={loading ? "…" : `₹${(stats.totalSales / 100000).toFixed(1)}L`}
                    valueColor="#38BDF8"
                    sub="All retailers"
                />
            </div>
            ...
            >
                ...
                >
                    ...
                    <input
                        type="text"
                        placeholder="Search retailer or owner…"
                        value={search}
                                ...
                                filtered.map((r, i) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                ₹{getTotalSales(r).toLocaleString()}
                                            </td>
                                            <td style={{ padding: "14px 16px" }}>
...
const GrowerInsightsPage = () => {
    ...
    const crops = useMemo(
        () => [...new Set(growers.map((g) => g.crop).filter(Boolean))],
        [growers]
    );

    const stats = useMemo(() => {
        const totalLand = growers.reduce((s, g) => s + parseFloat(g.land ?? g.landArea ?? 0), 0);
        const highRisk = growers.filter((g) =>
            (g.risk ?? g.riskLevel ?? "").toLowerCase().includes("high")
        ).length;
        const avgRisk = growers.length
            ? Math.round(growers.reduce((s, g) => s + (g.riskScore ?? 0), 0) / growers.length)
            : 0;
        ...
        () =>
            growers.filter((g) => {
                ...
                const matchesSearch =
                    ...
                    (g.location ?? g.village ?? "").toLowerCase().includes(q);
                if (!matchesSearch) return false;
    ...
    const getLastContact = (g) =>
        g.lastContact ?? (g.lastVisit ? new Date(g.lastVisit).toLocaleDateString("en-IN") : "—");
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14 }}>
                ...
                <KpiCard
                    ...
                    value={loading ? "…" : `${stats.totalLand} Ac`}
                    valueColor="#F97316"
                    sub="Total acreage"
                />
                <KpiCard
            ...
            >
                ...
                >
                    ...
                    <input
                        type="text"
                        placeholder="Search grower or village…"
                        value={search}
                        onChange={(e) => setSearch(e.target.value)}
                        style={{
                            background: "transparent",
                        ...
                        filtered.map((g) => {
                            ...
                            const riskColor = risk.toLowerCase().includes("high")
                                ...
                                : risk.toLowerCase().includes("medium")
                                  ? "#F97316"
                                  : "#4ADE80";
                            const riskBg = risk.toLowerCase().includes("high")
                                ? "rgba(239,68,68,0.12)"
                                : risk.toLowerCase().includes("medium")
                                  ? "rgba(249,115,22,0.12)"
                                  : "rgba(74,222,128,0.12)";
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 6 }}>
                <FilterDropdown
                    options={["All Regions", "Jhansi Territory", "Patna Territory"]}
                    value={region}
                    onChange={setRegion}
                />
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14 }}>
                <KpiCard
                    ...
                    iconBg="rgba(74,222,128,0.2)"
                    label="Total Revenue"
                    value={rL ? "…" : `₹${(totalRevenue / 100000).toFixed(2)}L`}
                    valueColor="#4ADE80"
                    sub="All months loaded"
                />
                <KpiCard
                    icon={<TrendingUp size={22} />}
                    iconBg="rgba(56,189,248,0.2)"
                ...
                <KpiCard
                    ...
                    iconBg="rgba(168,85,247,0.2)"
                    label="Total Visits"
                    value={vL ? "…" : totalVisits}
                    valueColor="#A855F7"
                    sub="By status from DB"
                />
                <KpiCard
                    icon={<CheckCircle size={22} />}
                    iconBg="rgba(234,179,8,0.2)"
                    label="Total Retailers"
                    value={Array.isArray(rawRetailers) ? rawRetailers.length : "…"}
                    valueColor="#EAB308"
                    sub="Active in DB"
                />
            </div>
                        ...
                        <>
                            ...
                            >
                                {productDist.map((item, index) => (
                                    <div
                                        key={`${item._id ?? item.name ?? "prod"}-${index}`}
                                        style={{
                                            display: "flex",
                                            alignItems: "center",
                                            gap: 10,
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 16 }}>
                ...
                <Card style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                        {[
                            {
                                label: "Revenue records in DB",
                                value: rL ? "Loading…" : `${revenueData.length} months`,
                                color: "#4ADE80",
                            },
                            {
                                label: "Visit statuses tracked",
                                value: vL ? "Loading…" : `${visitData.length} categories`,
                                color: "#38BDF8",
                            },
                            {
                            ...
                            {
                                label: "Retailers registered",
                                value: Array.isArray(rawRetailers)
                                    ? `${rawRetailers.length} retailers`
                                    : "Loading…",
                                color: "#EAB308",
                            },
                        ].map((ins, idx) => (
                            ...
                            >
                                ...
                                <span style={{ fontSize: 13, fontWeight: 700, color: ins.color }}>
                                    {ins.value}
                                </span>
                            </div>
                        ))}
...
const VisitPlannerPage = () => {
    const { data: rawRetailers, loading, error } = useFetch("/retailers", []);
    const retailers = useMemo(
        () => (Array.isArray(rawRetailers) ? rawRetailers : []),
        [rawRetailers]
    );
            ...
            retailers
                .map((r, i) => {
                    ...
                    const score = Math.max(
                        40,
                        Math.min(99, 60 + outstanding / 500 + (i === 0 ? 10 : 0))
                    );
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 10 }}>
                <div style={{ display: "flex", gap: 12 }}>
                    ...
                    >
                        <Calendar size={14} /> {new Date().toLocaleDateString("en-IN")} ▾
                    </div>
                </div>
            </div>
                ...
                {[
                    {
                        ...
                        value: loading ? "…" : `${scored.length}`,
                        sub: "Today",
                    },
                    {
                        icon: <IndianRupee size={24} />,
                        label: "Revenue Potential",
                        value: loading ? "…" : `₹${Math.round(totalRevPotential).toLocaleString()}`,
                        sub: "Estimated",
                    },
                    {
                    ...
                    {scored.map((v, i) => (
                        <Card
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                background:
                                    i < 2 ? "rgba(74,222,128,0.03)" : "rgba(255,255,255,0.02)",
                                borderColor:
                                    i < 2 ? "rgba(74,222,128,0.2)" : "rgba(255,255,255,0.07)",
                            }}
                        >
                            <div
                                style={{
                                    ...
                                    height: 70,
                                    borderRadius: "50%",
                                    border: `4px solid ${v._score > 90 ? "#4ADE80" : v._score > 70 ? "#EAB308" : "#F97316"}`,
                                    display: "flex",
                                    flexDirection: "column",
                                    alignItems: "center",
                                    justifyContent: "center",
                            ...
                            <div style={{ flex: 1.2 }}>
                                ...
                                >
                                    <MapPin size={12} /> {v.location ?? v.address ?? "—"}
                                </div>
                                <div
                                    style={{
                                        display: "flex",
                                ...
                                >
                                    <div
                                        style={{
                                            ...
                                            padding: "2px 6px",
                                            borderRadius: 4,
                                            background: v._stockRisk.includes("Critical")
                                                ? "rgba(239,68,68,0.15)"
                                                : "rgba(249,115,22,0.15)",
                                            color: v._stockRisk.includes("Critical")
                                                ? "#EF4444"
                                                : "#F97316",
                                            fontWeight: 600,
                                        }}
                            ...
                            >
                                ...
                                >
                                    ₹{(v.outstanding ?? v.outstandingBalance ?? 0).toLocaleString()}
                                </div>
                            </div>
                            <div
                                style={{
                        ...
                        <div style={{ flexShrink: 0 }}>
                            <span
                                style={{
                                    ...
                                    background: prioBg(rec.priority),
                                    padding: "4px 10px",
                                    borderRadius: 6,
                                }}
                            >
                                {prioLabel(rec.priority)}
                            </span>
                        </div>
                        <div style={{ flex: 1 }}>
                            <div
                            ...
                            <div style={{ fontSize: 12, color: "#94A3B8" }}>
                                Type: <span style={{ color: "#CBD5E1" }}>{rec.type}</span>
                            </div>
                        </div>
...
const RiskAnalyzerPage = () => {
    ...
    const riskOverview = useMemo(() => {
        ...
        cropData.forEach((d) => {
            if (groups[d.level] !== undefined) groups[d.level] += d.risk;
        });
        ...
        return [
            ...
            {
                name: "Medium Risk",
                value: Math.round((groups.Medium / total) * 100),
                color: "#F97316",
            },
    ...
    const criticalProducts = useMemo(
        () =>
            Array.isArray(rawProducts)
                ? rawProducts.filter((p) => (p.alertLevel ?? "") === "Critical")
                : [],
        [rawProducts]
    );
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <PageHeader
                filterOptions={["Last 7 Days", "Last 30 Days", "This Season"]}
                filter={filter}
                onFilter={setFilter}
            />
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14 }}>
                <KpiCard
                    ...
                    value={cL ? "…" : cropData.some((d) => d.level === "High") ? "High" : "Medium"}
                    valueColor="#EF4444"
                    sub="From crop risk DB"
                />
                <KpiCard
                    icon={<Wheat size={22} />}
                    iconBg="rgba(249,115,22,0.2)"
                ...
                <KpiCard
                    ...
                    value={Array.isArray(rawProducts) ? criticalProducts.length : "…"}
                    valueColor="#EAB308"
                    sub="Stock at critical"
                />
                <KpiCard
            ...
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 16 }}>
                <Card>
                    ...
                    >
                        Crop Risk by Level (Live from DB)
                    </div>
                    {cL ? (
                        <Spinner height={250} />
                    ) : (
                ...
                <Card>
                    ...
                    >
                        {riskOverview.map((d) => (
                            <div key={d.name} style={{ fontSize: 11, color: "#94A3B8" }}>
    ...
    const FormInput = ({ label, value, onChange, readOnly }) => (
        <div style={{ display: "flex", flexDirection: "column", gap: 6, flex: 1 }}>
            ...
            <input
                ...
                onFocus={(e) => {
                    if (!readOnly) e.target.style.borderColor = "rgba(74,222,128,0.4)";
                }}
                onBlur={(e) => {
                    if (!readOnly) e.target.style.borderColor = "rgba(255,255,255,0.08)";
                }}
            />
        </div>
    );
                ...
                {[
                    ...
                    <button
                        ...
                        style={{
                            ...
                            textAlign: "left",
                            background:
                                activeTab === t.id ? "rgba(74,222,128,0.12)" : "transparent",
                ...
                {activeTab === "profile" && (
                    <>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: 12, color: "#64748B", marginTop: 2 }}>
                                    {user.role ?? "Field Representative"} • {user.region ?? "—"}
                                </div>
                                <span
                                    style={{
                                        fontSize: 9,
                        ...
                        <Card style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                            ...
                            <div style={{ display: "flex", gap: 16 }}>
                                <FormInput label="Full Name" value={user.name ?? ""} readOnly />
                                <FormInput label="Email" value={user.email ?? ""} readOnly />
                            </div>
                            <div style={{ display: "flex", gap: 16 }}>
                                <FormInput label="Role" value={user.role ?? ""} readOnly />
                                <FormInput label="Region" value={user.region ?? ""} readOnly />
                            </div>
                            <div style={{ display: "flex", gap: 16 }}>
                                <FormInput
                                    label="Contact Phone"
                ...
                {activeTab === "preferences" && (
                    <>
                            ...
                            >
                                {[
                                    ...
                                    return (
                                        <div
                                            key={d.id}
                                            onClick={() => setDepot(d.id)}
                                            style={{
                                                background: isSel
                                                    ? "rgba(74,222,128,0.06)"
                                                    : "rgba(255,255,255,0.02)",
                                                border: `1px solid ${isSel ? "#4ADE80" : "rgba(255,255,255,0.07)"}`,
                                                borderRadius: 12,
                                                padding: 14,
                                                cursor: "pointer",
                                                transition: "all 0.2s",
                        ...
                        <Card style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                            ...
                            >
                                Notification & Field Alerts
                            </div>
                            {[
                                {
                                    label: "Critical Stock Alerts",
                                    desc: "Notify when inventory drops below 20%",
                                    state: stockAlerts,
                                    setState: setStockAlerts,
                                },
                                {
                                    label: "High Crop Risk Advisories",
                                    desc: "Notify when farm risk indexes increase to High",
                                    state: riskAlerts,
                                    setState: setRiskAlerts,
                                },
                                {
                                    label: "Weather Anomalies",
                                    desc: "Notify if rain forecast probability is above 60%",
                                    state: weatherAlerts,
                                    setState: setWeatherAlerts,
                                },
                            ].map((opt) => (
                                <div
                                    key={opt.label}
                ...
                {activeTab === "sync" && (
                    <Card style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                        ...
                        >
                            ...
                            >
                                Syncing updates offline distributor maps and weather forecasts.
                                Ensure stable internet before running.
                            </div>
                        </div>
                        <div
                            style={{
...
export default function App() {
    ...
    const fonts = (
        <>
            <link
                href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600&family=Space+Grotesk:wght@600;700;800&display=swap"
                rel="stylesheet"
            />
            <style>{`
